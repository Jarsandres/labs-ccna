...
- [R-HQ_startup-config.txt](./configs/R-HQ_startup-config.txt)
- [R-Branch-A_startup-config.txt](./configs/R-Branch-A_startup-config.txt)
- [R-Branch-B_startup-config.txt](./configs/R-Branch-B_startup-config.txt)
- [SW-HQ_startup-config.txt](./configs/SW-HQ_startup-config.txt)
- [SW-Branch-A_startup-config.txt](./configs/SW-Branch-A_startup-config.txt)
- [SW-Branch-B_startup-config.txt](./configs/SW-Branch-B_startup-config.txt)
